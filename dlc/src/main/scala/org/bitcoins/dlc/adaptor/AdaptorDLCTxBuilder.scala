...
case class AdaptorDLCTxBuilder(offer: DLCOffer, accept: DLCAcceptWithoutSigs)(
  ...
  def getPayouts(
    ...
    AdaptorDLCTxBuilder.getPayouts(oracleSig,
                                   sigPubKeys,
                                   offerOutcomes,
                                   acceptOutcomes)
  }
...
object AdaptorDLCTxBuilder {

  /** Place-holder vbytes for a CET/Refund Tx TODO: compute this */
