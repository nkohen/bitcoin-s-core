...
public class NativeSecp256k1Test {
    ...
    @Test
    public void testPubKeyTableMemoize() throws AssertFailException {
        byte[] key00 = toByteArray("028FEAB9641766B1B2E31CB59A8C034EDFE19F18742748EF0075E1B1A05AD130C0");
        byte[] key01 = toByteArray("0386B677935D899A41ACD6764F295ABDBD282D497429317FA7B8868C9B18732BB1");
        byte[] key10 = toByteArray("029F9747D73E11306882BB98BB47045DE2E4EADC5DFD434D38FA0003F39AB329AF");
        byte[] key11 = toByteArray("0356206011E9C023CD7852B2074905D4AB2DDFB95C1B200EFCC63EE5542B8F1A3E");
        byte[] key20 = toByteArray("03208EE2F655DC51A2B374B0D92382D08C8C47B8392D760BC0DD1B6A7A6BB11B52");
        byte[] key21 = toByteArray("03C6A9953B20403F13A186025F8DF0AEE18E24803551A2E6D37D9B2F3F15FE09EC");
        byte[][] keys = { key00, key01, key10, key11, key20, key21 };

        byte[][] tree = NativeSecp256k1.pubKeyTableMemoize(keys);

        String[] hexTree = new String[tree.length];
        for (int i = 0; i < tree.length; i++) {
            hexTree[i] = toHex(tree[i]);
        }
        String[] expectedTree = {
        ...
        for (int i = 0; i < tree.length; i++) {
            assertEquals(hexTree[i], expectedTree[i], "testPubKeyTableMemoize(" + i + ")");
        }
    }
