...
val utxoInfo = UTXOSatisfyingInfo(inputInfo = InputInfo(outPoint = outPoint,
                                                        output = utxo,
...
val utxos: Vector[UTXOSatisfyingInfo[InputInfo]] = Vector(utxoInfo)
...
// the corresponding UTXOSatisfyingInfo to produce a validly
