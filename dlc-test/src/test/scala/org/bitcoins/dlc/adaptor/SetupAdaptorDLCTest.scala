...
class SetupAdaptorDLCTest extends BitcoinSAsyncTest {
  ...
  val validCETInfo: AdaptorCETInfo = AdaptorCETInfo(validCET, dummyAdaptorSig)
  ...
  def setupDLC(
      ...
      cet0: AdaptorCETInfo = validCETInfo,
      cet1: AdaptorCETInfo = validCETInfo,
      refundTx: Transaction = validRefundTx): SetupAdaptorDLC = {
    SetupAdaptorDLC(
      fundingTx = fundingTx,
